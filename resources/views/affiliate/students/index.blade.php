    ...
    <div class="mt-6 sm:mt-8">
        ...
        <div class="w-full bg-white dark:bg-[#111a22] rounded-xl border border-gray-200 dark:border-[#324d67] overflow-hidden">
            <div class="p-4 sm:p-5 border-b border-gray-200 dark:border-[#324d67]">
                <h2 class="text-base sm:text-lg font-bold text-gray-900 dark:text-white">Students Who Registered and Paid</h2>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-[#324d67]">
                        @forelse($students as $student)
                            <tr>
                                ...
                                <td class="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{{ $student->payment_date ? $student->payment_date->format('Y-m-d') : 'N/A' }}</p>
                                </td>
                                <td class="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                                ...
                                <td class="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap text-right">
                                    <p class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">₵40.00</p>
                                </td>
                            </tr>
                        @empty
                            <tr>
            ...
            @if($students->count() > 0)
                <div class="p-4 sm:p-5 border-t border-gray-200 dark:border-[#324d67] bg-gray-50 dark:bg-gray-800">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
                        ...
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400"><strong>Total Commission:</strong> ₵{{ number_format($students->total() * 40, 2) }}</p>
                    </div>
                </div>
            @endif
        </div>
