...
<body class="bg-background-dark font-display">
    <!-- Navigation -->
    <nav x-data="{ open: false }" class="fixed top-0 w-full z-50 bg-surface-dark/30 backdrop-blur-sm border-b border-border-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <button @click="open = !open" class="md:hidden inline-flex items-center justify-center p-2 rounded-md text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/20">
        ...
        <div x-show="open" 
             ...
             class="md:hidden bg-surface-dark/95 backdrop-blur-sm border-t border-border-dark"
             style="display: none;">
            <div class="px-2 pt-2 pb-3 space-y-1">
                <a href="#about" @click="open = false" class="block text-white/80 hover:text-white hover:bg-white/5 transition px-3 py-2 rounded-lg">About</a>
                <a href="#curriculum" @click="open = false" class="block text-white/80 hover:text-white hover:bg-white/5 transition px-3 py-2 rounded-lg">Curriculum</a>
                <a href="#testimonials" @click="open = false" class="block text-white/80 hover:text-white hover:bg-white/5 transition px-3 py-2 rounded-lg">Testimonials</a>
                <a href="#faq" @click="open = false" class="block text-white/80 hover:text-white hover:bg-white/5 transition px-3 py-2 rounded-lg">FAQ</a>
                <div class="pt-2 border-t border-white/10">
                    ...
                    @else
                        <a href="{{ route('login') }}" @click="open = false" class="block text-white/80 hover:text-white hover:bg-white/5 transition px-3 py-2 rounded-lg">Login</a>
    ...
    <!-- Hero Section -->
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 lg:py-24 xl:py-32">
            <div class="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
                <div class="animate-fadeInUp">
                    ...
                    <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 sm:mb-8 text-white leading-[1.1] tracking-tight">
                    ...
                    <p class="text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8 lg:mb-10 leading-relaxed max-w-2xl">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 sm:gap-5 mb-8 sm:mb-10 lg:mb-12">
                        ...
                        <a href="#curriculum" class="px-6 sm:px-8 py-3 sm:py-4 bg-white/5 text-white rounded-xl font-semibold text-base sm:text-lg border border-white/10 hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2 backdrop-blur-sm">
                            <span class="material-symbols-outlined">menu_book</span>
                            <span>View Curriculum</span>
                        </a>
                    </div>
                    <div class="flex flex-wrap items-center gap-y-3 sm:gap-y-4 gap-x-4 sm:gap-x-8 text-xs sm:text-sm font-medium text-gray-400">
    ...
    <!-- Features Section -->
    <section id="about" class="py-12 sm:py-16 lg:py-24 bg-background-dark relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="text-center mb-12 sm:mb-16 lg:mb-20 max-w-3xl mx-auto">
                <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 tracking-tight">Why Choose Our Program?</h2>
                <p class="text-text-muted-dark text-base sm:text-lg leading-relaxed px-4">We provide a comprehensive learning experience that combines theory with practical application, ensuring you're ready for the AI-driven future.</p>
            </div>
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <!-- Feature Cards with refined styling -->
                <div class="group p-6 sm:p-8 rounded-2xl bg-surface-dark border border-white/5 hover:border-purple-500/30 hover:bg-purple-500/5 transition-all duration-300 relative overflow-hidden">
                    ...
                    <h3 class="text-white text-lg sm:text-xl font-bold mb-2 sm:mb-3">Professional Certification</h3>
                    <p class="text-text-muted-dark text-sm sm:text-base leading-relaxed">Earn a recognized AI Literacy Professional certificate upon completion to validate your expertise.</p>
                </div>
    ...
    <!-- Curriculum Section -->
    <section id="curriculum" class="py-12 sm:py-16 lg:py-24 bg-background-dark border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="text-center mb-12 sm:mb-16 lg:mb-20 max-w-3xl mx-auto">
                <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 tracking-tight">5-Day Curriculum</h2>
                <p class="text-text-muted-dark text-base sm:text-lg leading-relaxed px-4">A structured learning path designed to take you from fundamentals to advanced application.</p>
            </div>
            <div class="space-y-4 sm:space-y-6 max-w-5xl mx-auto">
                ...
                <div class="group flex flex-col md:flex-row gap-4 sm:gap-6 lg:gap-8 p-6 sm:p-8 rounded-2xl bg-surface-dark border border-white/5 hover:border-{{ $day['color'] }}-500/30 transition-all duration-300 relative overflow-hidden">
                    ...
                    <div class="flex-1">
                        <h3 class="text-white text-xl sm:text-2xl font-bold mb-4 sm:mb-6 group-hover:text-{{ $day['color'] }}-400 transition-colors">{{ $day['title'] }}</h3>
    ...
    <section id="testimonials" class="py-12 sm:py-16 lg:py-24 bg-background-dark border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="text-center mb-12 sm:mb-16 lg:mb-20 max-w-3xl mx-auto">
                <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 tracking-tight">Success Stories</h2>
                <p class="text-text-muted-dark text-base sm:text-lg leading-relaxed px-4">Join hundreds of professionals who have transformed their careers through our program.</p>
            </div>
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                @foreach([
                ...
                <div class="testimonial-card flex flex-col gap-4 sm:gap-6 p-6 sm:p-8 rounded-2xl bg-surface-dark border border-white/5 hover:border-white/10 transition-all duration-300 hover:-translate-y-1">
                    <div class="flex items-center gap-3 sm:gap-4">
                        <div class="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 p-[2px] flex-shrink-0">
                            <div class="h-full w-full rounded-full bg-surface-dark flex items-center justify-center">
                                <span class="text-white font-bold text-base sm:text-lg">{{ strtoupper(substr($testimonial['name'], 0, 1)) }}</span>
                            </div>
                        </div>
                        <div>
                            <h4 class="text-white font-bold text-base sm:text-lg">{{ $testimonial['name'] }}</h4>
                            <p class="text-text-muted-dark text-xs sm:text-sm">{{ $testimonial['role'] }}</p>
                        </div>
                    </div>
                    ...
                    <p class="text-gray-400 text-sm sm:text-base leading-relaxed italic">"{{ $testimonial['text'] }}"</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <!-- FAQ Section -->
    <section id="faq" class="py-12 sm:py-16 lg:py-24 bg-background-dark border-t border-white/5">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
            <div class="text-center mb-12 sm:mb-16 lg:mb-20 max-w-3xl mx-auto">
                <h2 class="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 tracking-tight">Frequently Asked Questions</h2>
                <p class="text-text-muted-dark text-base sm:text-lg leading-relaxed px-4">Everything you need to know about our program and what to expect.</p>
            </div>
            <div class="grid sm:grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-6xl mx-auto">
                ...
                <div class="faq-item h-fit rounded-2xl bg-surface-dark border border-white/5 hover:border-white/10 transition-all duration-300 overflow-hidden group">
                    <button class="w-full flex justify-between items-start sm:items-center p-4 sm:p-6 text-left focus:outline-none gap-3" onclick="toggleFaq({{ $index }})">
                        <h3 class="text-white text-sm sm:text-base font-semibold pr-2 sm:pr-8 group-hover:text-primary transition-colors flex-1">{{ $faq['q'] }}</h3>
                        <span class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10 rounded-full bg-white/5 flex items-center justify-center text-primary transition-all duration-300 group-hover:bg-primary/10" id="faq-icon-wrapper-{{ $index }}">
                            <span class="material-symbols-outlined text-xl sm:text-2xl" id="faq-icon-{{ $index }}">add</span>
                            </span>
                    </button>
                    <div class="faq-content px-4 sm:px-6 pb-0 text-text-muted-dark text-sm sm:text-base leading-relaxed opacity-0 transition-all duration-300">
                        <div class="pb-4 sm:pb-6 border-t border-white/5 pt-3 sm:pt-4">
                            {{ $faq['a'] }}
                        </div>
                    </div>
                </div>
    ...
    <!-- CTA Section -->
    <section class="py-12 sm:py-16 lg:py-24 bg-gradient-to-b from-surface-dark to-background-dark border-t border-white/5 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center relative z-10">
            <h2 class="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-4 sm:mb-6 text-white tracking-tight">Ready to Become an AI Professional?</h2>
            <p class="text-text-muted-dark text-base sm:text-lg lg:text-xl mb-6 sm:mb-8 lg:mb-10 max-w-2xl mx-auto px-4">Join hundreds of professionals who have transformed their careers with our AI Literacy Certification Program</p>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-xs sm:text-sm font-medium text-gray-400">
    ...
    <!-- Footer -->
    <footer class="bg-surface-dark border-t border-border-dark py-8 sm:py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
