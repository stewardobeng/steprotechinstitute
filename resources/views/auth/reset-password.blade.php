                        ...
                        <div class="w-full max-w-[480px]">
                            <div class="flex flex-wrap justify-between gap-3 pb-3 sm:pb-4">
                                <div class="flex flex-col gap-2">
                                    <p class="text-slate-900 dark:text-white text-2xl sm:text-3xl lg:text-4xl font-black leading-tight tracking-[-0.033em]">Reset Password</p>
                                    <p class="text-slate-600 dark:text-[#92adc9] text-sm sm:text-base font-normal leading-normal">Enter your new password below.</p>
                                </div>
                            </div>
                            ...
                            <form method="POST" action="{{ route('password.store') }}" class="flex w-full flex-col gap-4">
                                @csrf
                                ...
                                <!-- Password -->
                                <label class="flex flex-col flex-1">
                                    <p class="text-slate-800 dark:text-white text-base font-medium leading-normal pb-2">New Password</p>
                                    <div class="flex w-full flex-1 items-stretch rounded-lg">
                                        ...
                                        />
                                        <div class="text-slate-500 dark:text-[#92adc9] flex border border-slate-300 dark:border-[#324d67] bg-background-light dark:bg-[#192633] items-center justify-center pr-[15px] rounded-r-lg border-l-0 cursor-pointer" onclick="togglePassword('password', 'password-toggle-icon')">
                                ...
                                <label class="flex flex-col flex-1">
                                    ...
                                    <div class="flex w-full flex-1 items-stretch rounded-lg">
                                        ...
                                        />
                                        <div class="text-slate-500 dark:text-[#92adc9] flex border border-slate-300 dark:border-[#324d67] bg-background-light dark:bg-[#192633] items-center justify-center pr-[15px] rounded-r-lg border-l-0 cursor-pointer" onclick="togglePassword('password_confirmation', 'password-confirm-toggle-icon')">
                                            <span class="material-symbols-outlined" id="password-confirm-toggle-icon">visibility</span>
                                        </div>
                                    </div>
